(function() {
	...
	function init() {
		...
		newDOM('login-btn').addEventListener('click', login);// login()
																// defined at
																// LOGIN SETTING
		newDOM('nearby-btn').addEventListener('click', loadNearbyRestaurants);// defined
																				// in
																				// RESTAURANTS
																				// SETTING
		newDOM('fav-btn').addEventListener('click', loadFavoriteRestaurants); // defined
																				// in
																				// RESTAURANTS
																				// SETTING
		newDOM('recommend-btn').addEventListener('click',
				loadRecommendedRestaurants); // defined in RESTAURANTS
												// SETTING
