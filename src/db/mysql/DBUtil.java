...
//    public static final String URL = "jdbc:mysql://" + HOSTNAME + ":" + PORT_NUM + "/" + DB_NAME + "?user=" + USERNAME + "&password=" + PASSWORD + "&autoreconnect=true";
    ...
    private static final String HOSTNAME = "az-foodie-mydb.mysql.database.azure.com"; // az-foodie-db.mysql.database.azure.com 52.175.33.150
    private static final String PORT_NUM = "3306";
    public static final String DB_NAME = "foodie";
    static final String USERNAME = "x_xiao2_bnu@az-foodie-mydb";
